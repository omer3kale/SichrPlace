...
-- ===== STEP 4: PAYMENT AND TRANSACTION TABLES =====
...
CREATE TABLE apartment_reviews (
    ...
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    UNIQUE(apartment_id, reviewer_id)
);
...
-- ===== STEP 6: ADMIN AND SUPPORT TABLES =====
...
-- ===== STEP 8: ANALYTICS AND TRACKING TABLES =====

-- 8.1 Apartment Analytics
...
CREATE TABLE search_history (
    ...
    clicked_apartment_id UUID REFERENCES apartments(id) ON DELETE SET NULL,
...
CREATE INDEX idx_apartment_reviews_apartment_id ON apartment_reviews(apartment_id);
CREATE INDEX idx_apartment_reviews_reviewer_id ON apartment_reviews(reviewer_id);
...
-- ===== STEP 10: TRIGGERS FOR AUTO-UPDATES =====
...
-- ===== STEP 11: INITIAL SYSTEM SETTINGS =====
...
-- ===== STEP 12: SAMPLE DATA FOR TESTING =====
